...
- **npm package**: The `2.2.7` tarball on the registry omitted `fesm2022/` and `types/`. **2.2.9** republishes the same library with a complete build. No API or feature changes versus the intended 2.2.7 release.
...
No breaking changes. Use **2.2.9** on npm (the `2.2.7` npm package was incomplete; 2.2.9 matches the intended 2.2.7 release).
